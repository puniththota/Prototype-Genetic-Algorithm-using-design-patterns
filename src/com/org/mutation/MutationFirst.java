...
/**
 * The Class MutationFirst is one type of mutation class that implements the mutation interface to perform it's own type of mutation
 */
public class MutationFirst implements Mutation {
...
public Mutation mutation(Population population) {
	System.out.println("Mutation first");
